		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 animate__animated animate__slideInUp animate__slow"  style="background-color:black;">
					<a href="crud2.jsp" class="site-btn header-btn mx-1">control Panel</a>
	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container">
			<div class="hero-text text-white">
				...
				<p>Sit tight and listen the classes carefully</p>
			</div>
			...
			<div class="footer-warp">
				<div class="row">
					...
					<div class="widget-item">
						<h4>Staff List</h4>
						<ul class="contact-list">
							<li><a href="">132 P Gopichand</a></li>
							<li><a href="">182 Suvadeep</a></li>
							<li><a href="">232 Bala</a></li>
							<li><a href="">123 Udit</a></li>
