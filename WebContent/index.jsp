				...
				<div class="col-lg-3 col-md-3">
					<div class="site-logo">
						<h4 class="animate__animated animate__slideInDown animate__slow"
							style="color: white; padding: 1px;">Virtual Classroom</h4>
					</div>
	...
	<section class="hero-section set-bg" data-setbg="img/bg5.jpg">
		<div class="container">
			<div class="hero-text text-white">
				<h2 style="color: white; text-shadow: 2px 2px 5px black;"
				...
				<h4
					...
					Sit tight and listen the classes carefully
					<br />
					and we are here to train you
				</h4>
			</div>
